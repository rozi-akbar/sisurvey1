                            ...
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        $query = "DELETE FROM tbl_tahun_ajaran where id_tahun_ajaran='$_POST[id_tahun_ajaran]'";
                                        ...
                                        <form method="post">
                                            ...
                                            <table border="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>
                                                        <input type="text" name="detail_tahun_ajaran" value="<?php echo $detail_tahun_ajaran; ?>" readonly="true">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
