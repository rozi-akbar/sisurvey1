                        ...
                        <div class="span12">      		
                            ...
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                    <a href="insert_user.php">Tambah data</a>
                                    <?php
                                    include './koneksiDb.php';
                                    // main 
                                    $database = new koneksiDb("localhost", "root", "", "survey3");
                                    $database->execute_query("select * from survey3.tbl_user");
                                    $hasil = '';
                                    ...
                                    while ($baris = @mysqli_fetch_assoc($database->getHasil())) {
                                        $hasil .= '<td>' . $no=$no+1 . '</td><td>' . $baris['id_user'] . '</td><td>' . $baris['nama'] . '</td><td>' . $baris['username'] . '</td><td>' . $baris['password'] .
                                                '</td><td>' . $baris['no_hp'] . '</td><td>' . $baris['level'] . '</td><td>' . $baris['status'] . '</td><td>
                                                        <a href="update_user.php?id=' . $baris['id_user'] . '">edit</a>
                                                        <a href="hapus_user.php?id=' . $baris['id_user'] . '">hapus</a>';
                                        $hasil .= '</td></tr>';
                                    }
                                    echo $hasil;
                                    ?>
