                            ...
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        $query = "DELETE FROM survey3.tbl_matkul where id_matkul='$_POST[id_matkul]'";
                                        ...
                                        <form method="post">
                                            ...
                                            <table border="0">
                                                ...
                                                <tr><td>Nama Matakuliah</td><td>:</td><td>
                                                        <input type="text" name="nama_matakuliah" value="<?php echo $nama_matkul; ?>" readonly="true"> </td></tr>
                                                <tr><td></td><td></td><td><input type="submit" name="submit" value="Hapus"></td></tr> 
                                            </table>
                                            <a href="utama_matakuliah.php">Batal</a>
                                        </form>
                                    <?php } ?>
                                </div> <!-- /widget-content -->
                            </div> <!-- /widget -->
