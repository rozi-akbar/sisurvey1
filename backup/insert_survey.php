                            ...
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        $query = "INSERT INTO survey3.tbl_user VALUES (
                                                   '" . $_POST['id_user'] . "',
                                                   '" . $_POST['nama'] . "',
                                                   '" . $_POST['username'] . "',
                                                   '" . $_POST['password'] . "',
                                        ...
                                        if ($berhasil) {
                                            echo '<script> alert("Insert data berhasil");
                                                        window.location = "utama_user.php";</script>';
                                        } else {
                                    ...
                                    function isiData($koneksi) {
                                        $id_user = $_GET['id'];
                                        $query = "SELECT nama, username, password, no_hp, status from survey3.tbl_user where id_user='" . $id_user . "'";
                                        $koneksi->execute_query($query);
                                        $hasil = @mysqli_fetch_assoc($koneksi->getHasil());
                                        tampilkanFormUpdate($id_user, $hasil['nama'], $hasil['username'], $hasil['password'], $hasil['no_hp'], $hasil['status']);
                                    }

                                    function tampilkanFormUpdate($id_user, $nama, $username, $password, $no_hp, $status) {
                                        ...
                                        <form method="post">
                                            ...
                                            <table border="0">
                                                <tr><td>ID User</td><td>:</td><td>
                                                        <input type="text" name="id_user" </td></tr>
