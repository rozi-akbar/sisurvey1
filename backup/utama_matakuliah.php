                        ...
                        <div class="span12">      		
                            ...
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                    <a href="insert_matakuliah.php">Tambah data</a>
                                    <?php
                                    include './koneksiDb.php';
                                    // main 
                                    $database = new koneksiDb("localhost", "root", "", "survey3");
                                    $database->execute_query("select * from survey3.tbl_matkul");
                                    $hasil = '';
                                    ...
                                    while ($baris = @mysqli_fetch_assoc($database->getHasil())) {
                                        $hasil .= '<td>'. $no=$no+1 .'</td><td>' . $baris['id_matkul'] . '</td><td>' . $baris['nama_matkul'] . '</td><td>
                                                        <a href="update_matakuliah.php?id=' . $baris['id_matkul'] . '">edit</a>
                                                        <a href="hapus_matakuliah.php?id=' . $baris['id_matkul'] . '">hapus</a>';
                                        $hasil .= '</td></tr>';
                                    }
                                    echo $hasil;
                                    ?>
